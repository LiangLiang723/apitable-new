...
public class SelfHostedEnterpriseSubscriptionInfo extends DefaultSubscriptionInfo {
    ...
    public SelfHostedEnterpriseSubscriptionInfo() {
        super("Enterprise", "enterprise", new SelfHostedEnterpriseSubscriptionFeature());
    }
    ...
    public SubscriptionConfig getConfig() {
        return SubscriptionConfig.create().setAllowCreditOverLimit(true);
    }
}
