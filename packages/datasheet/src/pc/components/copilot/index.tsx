  ...
  return (
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column', background: 'var(--defaultBg)' }}>
      ...
      <div style={{ padding: 20, color: 'var(--firstLevelText)' }}>
        <div style={{ fontSize: 14, fontWeight: 600, marginBottom: 8 }}>AI 服务未配置</div>
        <div style={{ fontSize: 13, lineHeight: '20px', color: 'var(--secondLevelText)' }}>
          自托管企业版已开放 Copilot 入口。连接 AI 服务后即可使用助手面板。
        </div>
        {helpUrl && (
          <a href={helpUrl} target="_blank" rel="noreferrer" style={{ display: 'inline-block', marginTop: 16 }}>
            打开 AI 配置帮助
          </a>
        )}
      </div>
