...
const enterpriseFeatureVisible = (value?: string) => selfHostedEnterprise || value === 'true';
const unlimitedUiLimit = `${Number.MAX_SAFE_INTEGER}`;
...
export const getEnvVars = () => {
  return {
    ...
    REGENERATE_API_TOKEN_VISIBLE: enterpriseFeatureVisible(process.env.REGENERATE_API_TOKEN_VISIBLE),
    ...
    FIELD_CASCADE_VISIBLE: enterpriseFeatureVisible(process.env.FIELD_CASCADE_VISIBLE),
    ...
    SECURITY_GLOBAL_WATERMARK_VISIBLE: enterpriseFeatureVisible(process.env.SECURITY_GLOBAL_WATERMARK_VISIBLE),
    SECURITY_SPECIFY_MEMBER_TO_EXPORT_DATA_VISIBLE: enterpriseFeatureVisible(process.env.SECURITY_SPECIFY_MEMBER_TO_EXPORT_DATA_VISIBLE),
    SECURITY_MEMBER_CREATE_PUBLIC_LINK_VISIBLE: enterpriseFeatureVisible(process.env.SECURITY_MEMBER_CREATE_PUBLIC_LINK_VISIBLE),
    SECURITY_MEMBER_COPY_DATA_VISIBLE: enterpriseFeatureVisible(process.env.SECURITY_MEMBER_COPY_DATA_VISIBLE),
    SECURITY_MEMBER_DOWNLOAD_ATTCHMENT_VISIBLE: enterpriseFeatureVisible(process.env.SECURITY_MEMBER_DOWNLOAD_ATTCHMENT_VISIBLE),
    SECURITY_MEMBER_INVITE_USER_VISIBLE: enterpriseFeatureVisible(process.env.SECURITY_MEMBER_INVITE_USER_VISIBLE),
    SECURITY_USER_APPLY_TO_JOIN_SPACE_VISIBLE: enterpriseFeatureVisible(process.env.SECURITY_USER_APPLY_TO_JOIN_SPACE_VISIBLE),
    SECURITY_MEMBER_MODIFY_ROOT_CATALOG_VISIBLE: enterpriseFeatureVisible(process.env.SECURITY_MEMBER_MODIFY_ROOT_CATALOG_VISIBLE),
    SECURITY_CONTACTS_ISOLATION_VISIBLE: enterpriseFeatureVisible(process.env.SECURITY_CONTACTS_ISOLATION_VISIBLE),
    SECURITY_SHOW_MEMBER_PHONE_NUMBER_VISIBLE: enterpriseFeatureVisible(process.env.SECURITY_SHOW_MEMBER_PHONE_NUMBER_VISIBLE),
    SPACE_LOGS_VISIBLE: enterpriseFeatureVisible(process.env.SPACE_LOGS_VISIBLE),
    ...
    TIME_MACHINE_VISIBLE: enterpriseFeatureVisible(process.env.TIME_MACHINE_VISIBLE),
    ...
    SPACE_PERMISSION_OVERVIEW_VISIBLE: enterpriseFeatureVisible(process.env.SPACE_PERMISSION_OVERVIEW_VISIBLE),
    SPACE_SECURITY_PAGE_VISIBLE: enterpriseFeatureVisible(process.env.SPACE_SECURITY_PAGE_VISIBLE),
    ...
    CUSTOM_WIDGET_VISIBLE: enterpriseFeatureVisible(process.env.CUSTOM_WIDGET_VISIBLE),
    ...
    MAXIMUM_VIEW_COUNT_PER_DATASHEET: selfHostedEnterprise ? unlimitedUiLimit : process.env.MAXIMUM_VIEW_COUNT_PER_DATASHEET,
    MAXIMUM_MANAGEABLE_SPACE_COUNT_PER_USER: selfHostedEnterprise ? unlimitedUiLimit : process.env.MAXIMUM_MANAGEABLE_SPACE_COUNT_PER_USER,
    MAXIMUM_FIELD_COUNT_PER_DATASHEET: selfHostedEnterprise ? unlimitedUiLimit : process.env.MAXIMUM_FIELD_COUNT_PER_DATASHEET,
    WELCOME_CONFIG: process.env.WELCOME_CONFIG,
    WIDGET_REPO_PREFIX: process.env.WIDGET_REPO_PREFIX,
    SPACE_ROLE_VISIBLE: enterpriseFeatureVisible(process.env.SPACE_ROLE_VISIBLE),
    ...
    ALARM_TIME_UTC_VISIBLE: enterpriseFeatureVisible(process.env.ALARM_TIME_UTC_VISIBLE),
    ...
    UNIT_LIST_TEAM_INFO_VISIBLE: enterpriseFeatureVisible(process.env.UNIT_LIST_TEAM_INFO_VISIBLE),
    WIDGET_CENTER_OFFICIAL_TIP_VISIBLE: process.env.WIDGET_CENTER_OFFICIAL_TIP_VISIBLE === 'true',
    IS_ENTERPRISE: selfHostedEnterprise || process.env.IS_ENTERPRISE === 'true',
    SELF_HOSTED_ENTERPRISE: selfHostedEnterprise,
    ...
    DASHBOARD_WIDGET_MAX_NUM: selfHostedEnterprise ? unlimitedUiLimit : process.env.DASHBOARD_WIDGET_MAX_NUM,
    ...
    IGNORE_IMG_SIZE_LIMIT: enterpriseFeatureVisible(process.env.IGNORE_IMG_SIZE_LIMIT),
    ...
    ENABLE_WORKDOC_FIELD: enterpriseFeatureVisible(process.env.ENABLE_WORKDOC_FIELD),
    ...
    ALLOW_EMBED_SEND_REMIND: enterpriseFeatureVisible(process.env.ALLOW_EMBED_SEND_REMIND),
